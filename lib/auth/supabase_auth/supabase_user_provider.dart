...
class SanofiEvelynSupabaseUser extends BaseAuthUser {
  SanofiEvelynSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> sanofiEvelynSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = SanofiEvelynSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
