...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/notificationAllow',
          builder: (context, params) => const NotificationAllowWidget(),
        ),
        FFRoute(
          name: 'Welcome',
          path: '/welcome',
        ...
        FFRoute(
          name: 'ponto',
          path: '/ponto',
          builder: (context, params) => const PontoWidget(),
        ),
        FFRoute(
          name: 'pesquisa',
          path: '/pesquisa',
        ...
        FFRoute(
          name: 'treinamentos',
          path: '/treinamentos',
          builder: (context, params) => const TreinamentosWidget(),
        ),
        FFRoute(
          name: 'gestao',
          path: '/gestao',
          builder: (context, params) => const GestaoWidget(),
        )
